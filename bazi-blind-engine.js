...
var parts = [];
// ========== 开篇：作者自序 ==========
parts.push("你这个八字我仔细看了。命不是迷信——是天地万物的规律落在了你身上。你这一生的高高低低、酸甜苦辣，都在里头了。");
// ========== 第一章：知命——看清你的底牌 ==========
parts.push("【知命篇】先说你的命格底色。");
parts.push("你这命格，日主是" + riWx + "，生在" + mg.zhi + "月。按《道德经》里一句话：'人法地，地法天，天法道，道法自然。'——你的命就是你这一生的'自然'。不是谁偏心——每个人落地那天的气场不一样。有的树长山上，有的树在水边，各有各的活法而已。");
if (!riStrong) {
...
parts.push("这就是你的命——你的底牌。底牌不是让你认命的东西。知道了自己手上什么牌，才好往下打。");
// ========== 第二章：释怀——放下你改变不了的 ==========
...
parts.push("释怀不是认怂——是放过自己。够不着的东西硬去够，够不着还把自己伤了。命里该有的，早晚是你的。不用急。");
// ========== 第三章：顺势——看清你的运势 ==========
...
if (!riStrong) changeAdvice.push("日主不够壮实——这是你一辈子都要补的课。怎么补？第一，别自己扛，学着找人搭把手。第二，做你拿手的、别眼红别人赚钱快。第三，身子是自己的——少熬夜，多休息。");
...
// ========== 结尾：本心寄语 ==========
parts.push("【本心寄语】");
parts.push("说了这么多，最要紧的一句话说给你——命是车，运是路，司机是你。车有好坏、路有平坎，但方向盘从头到尾都在你手里头。");
parts.push("《道德经》最后一句话：'天之道，利而不害；圣人之道，为而不争。'老天爷的规律是利万物而不伤害，做人的最高境界是努力做事但不跟人争。");
parts.push("你这个人，比你的八字厉害多了。知命，不认命。");
return parts;
}
